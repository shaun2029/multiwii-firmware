...
void LoadDefaults() {
  uint8_t i;
  ...
  #else
    #if PID_CONTROLLER == 1
      conf.pid[ROLL].P8     = 21;  conf.pid[ROLL].I8    = 21; conf.pid[ROLL].D8     = 17;
      conf.pid[PITCH].P8    = 21; conf.pid[PITCH].I8    = 21; conf.pid[PITCH].D8    = 17;
    ...
    #endif
    conf.pid[YAW].P8      = 46;  conf.pid[YAW].I8     = 35;  conf.pid[YAW].D8     = 0;
