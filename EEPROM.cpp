...
void LoadDefaults() {
  uint8_t i;
  ...
  #else
    #if PID_CONTROLLER == 1
      conf.pid[ROLL].P8     = 30;  conf.pid[ROLL].I8    = 26; conf.pid[ROLL].D8     = 19;
      conf.pid[PITCH].P8    = 30; conf.pid[PITCH].I8    = 26; conf.pid[PITCH].D8    = 19;
    ...
    #endif
    conf.pid[YAW].P8      = 56;  conf.pid[YAW].I8     = 35;  conf.pid[YAW].D8     = 0;
