...
void LoadDefaults() {
  ...
  #else
    #if PID_CONTROLLER == 1
      conf.pid[ROLL].P8     = 22;  conf.pid[ROLL].I8    = 31; conf.pid[ROLL].D8     = 23;
      conf.pid[PITCH].P8    = 22; conf.pid[PITCH].I8    = 31; conf.pid[PITCH].D8    = 23;
      conf.pid[PIDLEVEL].P8 = 60; conf.pid[PIDLEVEL].I8 = 10; conf.pid[PIDLEVEL].D8 = 100;
